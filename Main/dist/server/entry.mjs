...
import { A as clientAddressSymbol, C as isRoute500, D as REDIRECT_STATUS_CODES, E as DEFAULT_404_COMPONENT, F as responseSentSymbol$1, M as nodeRequestAbortControllerCleanupSymbol, N as originPathnameSymbol, O as REROUTABLE_STATUS_CODES, P as pipelineSymbol, S as isRoute404, T as ASTRO_GENERATOR, _ as isRenderInstruction, a as chunkToString, b as renderEndpoint, c as renderSlotToString, d as decodeKey, f as decryptString, i as renderComponent, j as fetchStateSymbol, k as appSymbol, l as isRenderTemplateResult, n as renderPage, o as createSlotValueFromString, p as generateCspDigest, r as renderJSX, u as renderTemplate, v as isAstroComponentFactory, w as ASTRO_ERROR_HEADER } from "./chunks/server_DiftD9Vj.mjs";
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/lily/.nvm/versions/node/v24.14.1/bin/npm" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/lily/.nvm/versions/node/v24.14.1/bin/npm" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
...
[
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/waitlist.astro",
			"pathname": "/waitlist",
			"prerender": false,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/node_CH5cvHh4.mjs");
var _page1 = () => import("./chunks/about_BwKrGetq.mjs");
var _page2 = () => import("./chunks/waitlist_BkLnZARQ.mjs");
var _page3 = () => import("./chunks/waitlist_C-k64sGA.mjs");
var _page4 = () => import("./chunks/index_DDOODrrd.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["node_modules/astro/dist/assets/endpoint/node.js", _page0],
	["src/pages/about.astro", _page1],
	["src/pages/api/waitlist.ts", _page2],
	["src/pages/waitlist.astro", _page3],
	["src/pages/index.astro", _page4]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///home/lily/Prova/Main/","cacheDir":"file:///home/lily/Prova/Main/node_modules/.astro/","outDir":"file:///home/lily/Prova/Main/dist/","srcDir":"file:///home/lily/Prova/Main/src/","publicDir":"file:///home/lily/Prova/Main/public/","buildClientDir":"file:///home/lily/Prova/Main/dist/client/","buildServerDir":"file:///home/lily/Prova/Main/dist/server/","adapterName":"@astrojs/node","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"type":"page","component":"_server-islands.astro","params":["name"],"segments":[[{"content":"_server-islands","dynamic":false,"spread":false}],[{"content":"name","dynamic":true,"spread":false}]],"pattern":"^\\/_server-islands\\/([^/]+?)\\/?$","prerender":false,"isIndex":false,"fallbackRoutes":[],"route":"/_server-islands/[name]","origin":"internal","distURL":[],"_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/_image","component":"node_modules/astro/dist/assets/endpoint/node.js","params":[],"pathname":"/_image","pattern":"^\\/_image\\/?$","segments":[[{"content":"_image","dynamic":false,"spread":false}]],"type":"endpoint","prerender":false,"fallbackRoutes":[],"distURL":[],"isIndex":false,"origin":"internal","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/about","isIndex":false,"type":"page","pattern":"^\\/about\\/?$","segments":[[{"content":"about","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/about.astro","pathname":"/about","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/api/waitlist","isIndex":false,"type":"endpoint","pattern":"^\\/api\\/waitlist\\/?$","segments":[[{"content":"api","dynamic":false,"spread":false}],[{"content":"waitlist","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/api/waitlist.ts","pathname":"/api/waitlist","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[],"routeData":{"route":"/waitlist","isIndex":false,"type":"page","pattern":"^\\/waitlist\\/?$","segments":[[{"content":"waitlist","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/waitlist.astro","pathname":"/waitlist","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"@font-face{font-family:Qalisso;src:url(/_astro/Qalisso.CU8txhYU.otf)format(\"opentype\");font-weight:400;font-style:normal}:root{color-scheme:light;--space-cadet:#25344f;--slate-grey:#617891;--white:#fff}html,body{min-height:100%;margin:0}body{background:var(--white);color:var(--space-cadet);font-family:Qalisso,Georgia,serif}.hero{background-image:linear-gradient(#fff3, #fff3), var(--hero-image);background-position:50% 10%;background-repeat:no-repeat;background-size:min(1200px,96vw);justify-content:center;align-items:center;gap:4rem;padding:5rem 2rem;display:flex}.hero-content{text-align:center}.hero-content h1{color:var(--space-cadet);margin-bottom:3rem;font-family:Qalisso;font-size:6rem;font-weight:700}.hero-content h2{color:var(--slate-grey);margin-bottom:1.5rem;font-family:Qalisso;font-size:2rem;font-weight:700}.waitlist-page{place-items:center;min-height:100vh;padding:3rem 1.5rem;display:grid}.waitlist-shell{gap:1.5rem;width:min(1040px,100%);display:grid}.waitlist-intro{justify-content:space-between;align-items:end;gap:1rem;padding:0 .35rem;display:flex}.waitlist-intro p{letter-spacing:.16em;text-transform:uppercase;color:var(--slate-grey);margin:0;font-size:.8rem}.waitlist-intro h2{color:var(--space-cadet);margin:0;font-size:clamp(1.35rem,3vw,2rem)}.waitlist-card{background:var(--white);backdrop-filter:blur(14px);border:1px solid #61789138;border-radius:28px;grid-template-columns:minmax(0,1.1fr) minmax(280px,420px);gap:2rem;padding:2rem;display:grid;box-shadow:0 24px 60px #25344f14,inset 0 1px #ffffffd9}.waitlist-copy{flex-direction:column;justify-content:center;gap:1rem;display:flex}.waitlist-eyebrow{letter-spacing:.18em;text-transform:uppercase;color:var(--slate-grey);margin:0;font-size:.8rem}.waitlist-copy h1{margin:0;font-size:clamp(2.5rem,4vw,4.5rem);line-height:.95}.waitlist-description{max-width:30rem;color:var(--slate-grey);margin:0;font-family:Georgia,serif;font-size:1.05rem;line-height:1.7}.waitlist-form{background:#6178910f;border:1px solid #6178912e;border-radius:22px;gap:1rem;padding:1.5rem;display:grid}.waitlist-field{color:var(--space-cadet);gap:.45rem;font-family:Georgia,serif;display:grid}.waitlist-field span{font-size:.95rem}.waitlist-field input{box-sizing:border-box;width:100%;font:inherit;color:var(--space-cadet);background:var(--white);border:1px solid #61789161;border-radius:14px;padding:.95rem 1rem;transition:border-color .2s,box-shadow .2s,transform .2s}.waitlist-field input::placeholder{color:#617891e6}.waitlist-field input:focus{border-color:var(--space-cadet);outline:none;transform:translateY(-1px);box-shadow:0 0 0 4px #61789133}.waitlist-submit{background:var(--space-cadet);color:var(--white);font:inherit;cursor:pointer;border:0;border-radius:999px;padding:1rem 1.3rem;font-size:1rem;transition:transform .2s,box-shadow .2s,opacity .2s,background-color .2s;box-shadow:0 14px 30px #25344f29}.waitlist-submit:hover{background:var(--slate-grey);transform:translateY(-1px)}.waitlist-submit:disabled{cursor:wait;opacity:.8;transform:none}.waitlist-message{min-height:1.5rem;color:var(--slate-grey);margin:0;font-family:Georgia,serif;line-height:1.5}.waitlist-message[data-tone=success],.waitlist-message[data-tone=error]{color:var(--space-cadet)}@media (width<=900px){.hero{background-position:top;background-size:155vw;padding:4rem 1.5rem 3rem}.waitlist-card{grid-template-columns:1fr;padding:1.5rem}.waitlist-copy h1{font-size:clamp(2.2rem,14vw,3.6rem)}}@media (width<=720px){.waitlist-page{padding:1.25rem}.waitlist-intro{flex-direction:column;align-items:start}}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":true,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/home/lily/Prova/Main/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.BBB4gUDt.mjs","\u0000noop-middleware":"virtual_astro_middleware.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_DS5V7T-N.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","@astrojs/node/server.js":"entry.mjs","\u0000virtual:astro:page:src/pages/about@_@astro":"chunks/about_BwKrGetq.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_DDOODrrd.mjs","\u0000virtual:astro:page:node_modules/astro/dist/assets/endpoint/node@_@js":"chunks/node_CH5cvHh4.mjs","/home/lily/Prova/Main/node_modules/astro/dist/assets/services/sharp.js":"chunks/sharp_BoEQmWFd.mjs","\u0000virtual:astro:page:src/pages/api/waitlist@_@ts":"chunks/waitlist_BkLnZARQ.mjs","\u0000virtual:astro:page:src/pages/waitlist@_@astro":"chunks/waitlist_C-k64sGA.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/favicon.ico","/favicon.svg","/_astro/background.BPKAcmfN.svg","/_astro/Qalisso.CU8txhYU.otf"],"buildFormat":"directory","checkOrigin":true,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"1pqbZo768hgwkwTBct2MnC6WJ9qbAaCGRlDm6F4bLSU=","sessionConfig":{"driver":"unstorage/drivers/fs-lite","options":{"base":"/home/lily/Prova/Main/node_modules/.astro/sessions"}},"image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
var mode = "standalone";
var client = "file:///home/lily/Prova/Main/dist/client/";
var server = "file:///home/lily/Prova/Main/dist/server/";
var port = 4321;
